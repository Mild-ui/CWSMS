    ...
    const handleReset = (e) => {
        ...
        axios.put('http://localhost:5000/reset-password', resetData)
            .then((res) => {
                ...
                navigate('/'); // Redirects cleanly back to your login screen
            })
            .catch((err) => {
                console.error(err);
        ...
        <div className="flex h-screen bg-slate-50 font-sans">
            ...
            <header className='w-64 bg-white border-r border-slate-200 flex flex-col justify-between p-6 shadow-sm'>
                ...
                <div className='border-t border-slate-100 pt-4 space-y-1'>
                    <Link to='/reset-password' className='flex items-center px-4 py-2.5 rounded-lg text-sm font-medium text-amber-600 bg-amber-50 transition-colors'>
                        Settings
                    </Link>
            ...
            {/* Main Content Area: Flex wrapper keeps your card centered perfectly */}
