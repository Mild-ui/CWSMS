        ...
        <div className='flex h-screen bg-slate-50 font-sans'>
            ...
            <main className='flex-1 p-10 overflow-y-auto space-y-6'>
                ...
                <div className="cars space-y-4">
                    <h1 className='text-2xl font-extrabold text-slate-800 tracking-tight'>Cars<span className='text-amber-500 font-medium italic font-serif'>Overview</span><Link to='/car/new' className='ml-190 text-sm border-none rounded-full p-2 bg-amber-500'>+Add Car</Link></h1>
                        ...
                        <table className='w-full text-left border-collapse'>
                            <thead>
                                <tr className="bg-slate-50 border-b border-slate-100 text-xs font-semibold uppercase tracking-wider text-slate-400">
                                    ...
                                    <th className='px-3 py-6'>Car Size</th>
                            ...
                            <tbody className='divide-y divide-slate-100 text-sm text-slate-700'>
                                ...
                                {CarList.map(cars => (
                                    <tr key={cars.PlateNumber} className="hover:bg-slate-50/70 transition-colors">
                                        <td className='py-4 px-6 font-mono text-xs text-slate-400'># {cars.PlateNumber}</td>
                                        <td className="py-4 px-6 font-semibold text-slate-900">{cars.CarType}</td>
                                        <td className='py-4 px-6'>{cars.CarSize}</td>
                                        <td className='py-4 px-6 font-medium text-amber-600"'>{cars.DriverName}</td>
